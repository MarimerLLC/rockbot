...
Use **schedule_task**, **cancel_scheduled_task**, and **list_scheduled_tasks** to create tasks that fire automatically and send results to the user. Before using these tools, load the full guide with `get_tool_guide("scheduling")`.
