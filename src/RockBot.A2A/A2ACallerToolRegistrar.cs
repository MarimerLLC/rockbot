    ...
    private const string InvokeAgentSchema = """
        {
          ...
          "properties": {
            ...
            "data": {
              "type": "object",
              "description": "Optional structured data payload sent alongside the text message as an A2A DataPart. Include it whenever the request has structured inputs — identifiers, records, parameters, filters, coordinates, enums, etc. — rather than stuffing them into the message text. Inspect the target skill's description, tags, and examples (via get_agent_details) for field hints. Must be a JSON object."
            },
            "timeout_minutes": {
              "type": "integer",
